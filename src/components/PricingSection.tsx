  ...
  return (
    <section id="pricing" className="py-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 text-center">
          ...
          <div className="bg-gradient-to-br from-amber-500/20 to-yellow-700/10 border border-amber-400/40 rounded-xl p-6">
            <p className="font-montserrat text-sm font-bold uppercase tracking-wider mb-2" style={{color:'#f5c542'}}>All-Access Pass</p>
            <p className="font-opensans text-sm text-muted leading-relaxed">Single bundle license including every active Viking EA, with all updates and priority support.</p>
          </div>
        </div>
